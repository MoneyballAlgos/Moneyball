...
from moneyball.settings import SMTP_SENDER_EMAIL, SMTP_SENDER_NAME, SMTP_SENDER_PASSWORD


def smtp_send_email(msg_html, subject, recipient, cc_email=None, bcc_email=None, file_name=None, payload=None):
    try:
        msg = EmailMessage()
        msg['Subject'] = subject
